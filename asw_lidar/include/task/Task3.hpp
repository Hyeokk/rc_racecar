...
void Task3::scanCallback(const sensor_msgs::LaserScan::ConstPtr &scan){
...
void Task3::initsetup(){
    ros::param::get("/Status_3/min_x_",  roi[0]);
    ros::param::get("/Status_3/max_x_",  roi[1]);
    ros::param::get("/Status_3/min_y_",  roi[2]);
    ros::param::get("/Status_3/max_y_",  roi[3]);

    ros::param::get("/Status_3/tolerance",  param[0]);
    ros::param::get("/Status_3/cluster_size_min",  param[1]);
    ros::param::get("/Status_3/cluster_size_max",  param[2]);
    ros::param::get("/Status_3/voxel_size", voxel_size);
    //------------pub----------------------------------------------------------------|
